      ...
      <div className="max-w-5xl mx-auto">
        ...
        <AnimatedContent direction="vertical" reverse={false} delay={0}>
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-black tracking-tight mb-2" style={{ color: '#a5f3fc' }}>
              Не просто список — твоя страница
            </h2>
            <p className="text-[#475569] text-base">Собирай из блоков всё что важно</p>
          </div>
        </AnimatedContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          <FadeContent blur duration={800} delay={200}>
            <div
              ...
              style={{ background: 'linear-gradient(180deg, #0a1628, #0d0025)', border: '1px solid rgba(139,92,246,0.12)' }}
            >
              <div className="rounded-xl px-4 py-3" style={{ background: 'linear-gradient(90deg, rgba(6,182,212,0.15), rgba(139,92,246,0.1))', borderLeft: '2px solid #06b6d4' }}>
                <p className="text-sm font-bold" style={{ color: '#a5f3fc' }}>День рождения Маши 🎂</p>
                <p className="text-xs mt-0.5" style={{ color: '#475569' }}>25 января · Жду вас!</p>
              </div>
              <div className="rounded-xl px-4 py-3" style={{ background: 'rgba(139,92,246,0.08)', borderLeft: '2px solid #8b5cf6' }}>
                <p className="text-xs" style={{ color: '#c4b5fd' }}>🖼️ Обложка события</p>
              </div>
              <div className="rounded-xl px-4 py-3" style={{ background: 'rgba(16,185,129,0.07)', borderLeft: '2px solid #10b981' }}>
                <p className="text-xs" style={{ color: '#6ee7b7' }}>⏱️ До праздника: 12 дней</p>
              </div>
              <div className="rounded-xl px-4 py-3" style={{ background: 'rgba(251,146,60,0.06)', borderLeft: '2px solid rgba(251,146,60,0.4)' }}>
                <p className="text-xs" style={{ color: '#fed7aa' }}>📍 Москва, Патриаршие пруды</p>
              </div>
              <div className="rounded-xl px-4 py-3 text-center" style={{ border: '1px dashed rgba(6,182,212,0.15)' }}>
