    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
        ...
        <button
          ...
          className="rounded-2xl overflow-hidden flex flex-col h-full border border-border hover:border-primary transition-colors text-left"
        >
          <div className="bg-gradient-to-br from-muted to-muted/60 px-4 pt-5 pb-3.5 text-center flex-1 flex flex-col items-center justify-center">
            <LayoutTemplate size={28} className="mb-1 text-muted-foreground" />
          </div>
          <div className="bg-muted/30 px-3.5 py-3 border-t-2 border-muted">
            <div className="font-bold text-sm mb-0.5">Пользовательские</div>
            <div className="text-xs text-muted-foreground">Шаблоны от сообщества</div>
          </div>
        </button>
      </div>
