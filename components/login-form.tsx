            ...
            <div className="grid gap-6">
              <div className="flex flex-col gap-4">
                <div className="widget_container" id='widget_container'>
                  <Script async src="https://telegram.org/js/telegram-widget.js?22" data-telegram-login="Getwishlist_bot"
                          data-size="large" data-auth-url="https://get-my-wishlist.ru/oauth" data-request-access="write"/>
                </div>
